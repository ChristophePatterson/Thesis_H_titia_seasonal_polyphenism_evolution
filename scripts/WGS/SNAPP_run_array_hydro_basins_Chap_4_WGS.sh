...
# Output directory
output_dir=(/home/tmjj24/scripts/Github/Thesis_H_titia_seasonal_polyphenism_evolution/data/SNAPP/Hydro_5_WGS_max_cov)
input_dir=(/home/tmjj24/scripts/Github/Thesis_H_titia_seasonal_polyphenism_evolution/data/SNPs/SNAPP)
mkdir -p $output_dir

# Input file prefix
phy_file=(titia.mysnps-SNAPP-hydro_5_max_cov)
...
ruby /home/tmjj24/scripts/job_scripts/Master-demulitiplex-scripts/ddRAD_Durham_and_Sheffield_CUAJ/SNAPP/snapp_prep.rb -p $input_dir/$phy_file.phy -t $input_dir/$phy_file.txt \
-c $input_dir/$phy_file.con.txt -l 1000000 -x $phy_file.xml -o $phy_file
