...
plot(tree.phylo.r2.HL, mar=c(0.2,0.1,1.1,0.2), xlim = c(4.8,7),lwd = 5, fsize = 8, colors = cols) ; text(5,8,"(c)", cex = 6) ; text(4.8, 6, "//", cex = 5) ; text(4.8, 1.5, "//", cex = 5)
plot(tree.phylo.r3.HL.P, mar=c(0.2,0.1,1.1,0.2), xlim = c(4.8,7),lwd = 5, fsize = 8, colors = cols) ; text(5,8,"(d)", cex = 6) ; text(4.8, 6, "//", cex = 5) ; text(4.8, 1.5, "//", col = "orange", cex = 5)
par(mfrow= (c(1,1)))
dev.off()
